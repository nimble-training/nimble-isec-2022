...
3. Overview of `nimbleEcology` with a worked hidden Markov model (HMM)
example.
4. Model selection and related topics in NIMBLE, with a worked
   meta-analysis example.
5. Introduction to `nimbleSCR` for spatial capture-recapture, with a worked example.
